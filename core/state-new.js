...
const defaultState = {
  ...
  // 🆕 Лист для печати примеров
  worksheet: {
    examples: [],      // массив примеров для печати
    settings: null,    // настройки, по которым сгенерирован лист
    createdAt: null,   // дата/время генерации (ISO-строка)
    showAnswers: false // флаг: печатать ли отдельный лист с ответами
  }
};
